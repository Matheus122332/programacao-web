...
$editarUsuario = $_GET["id"];

$sql = "SELECT * FROM usuario WHERE id='$editarUsuario'";
$resultadoUsuario = mysqli_query($conn, $sql);

while($x = mysqli_fetch_assoc($resultadoUsuario)){
    $nome = $x["nome"];
    $email = $x["email"];
    $idade = $x["idade"];
    $fone = $x["fone"];
    ...
    $login = $x["login"];
        ...
        if (isset($_POST["salvar"])) {
            ...
            if ($numLinhas == 0) {
                $sql = "UPDATE usuario SET nome = '$nome', email = '$email', idade = '$idade', fone = '$fone',
                 cpf = '$cpf',  rg = '$rg', login = '$login' WHERE id='$id'";
        ...
        <main class="content">
            ...
            <div class="campo">
                ...
                if($msg == "sucesso"){
                    echo "<div class='msg-verde'>Usuário editado com sucesso!</div>";
                }elseif($msg == "falha"){
                    echo "<div class='msg-vermelho'>Erro ao editar o usuário!</div>";
            ...
            <form action="#" method="post">
                ...
                <div class="campos">
                    <input type="hidden" name="id" value=" <?php echo $editarUsuario;?>">
